    ...
    const reviews = [
        {
            ...
            time: "3 months ago",
            stars: 5,
            comment: "Success in Business Automation. We hired GreenSolution to automate our entire sales process. The team worked efficiently and delivered exceptional results!",
            bgColor: "bg-red-200",
        },
        {
            id: 2,
        ...
        },
        {
            ...
            time: "2 months ago",
            stars: 5,
            comment: "The GreenSolution team responds quickly, releases updates frequently, and provides strong customer service. Their dedication to keeping the tool at the forefront is evident!",
        ...
        },
        {
            ...
            time: "9 months ago",
            stars: 5,
            comment: "In the modern business, GreenSolution has been a game-changer for me. Under the visionary leadership of CEO Sir Adnan Ghaffar, this platform delivers exceptional results.",
            bgColor: "bg-pink-200",
        },
        {
            id: 7,
            ...
            time: "1 year ago",
            stars: 5,
            comment: "AWESOME! GreenSolution team helped me automate my software and make it bug-free. Their prompt replies and fast work pace were remarkable. Highly Recommended!",
            bgColor: "bg-teal-200",
        },
        {
            id: 9,
            ...
            time: "11 months ago",
            stars: 5,
            comment: "We are delighted with both of our projects with GreenSolution. They made our applications fully testable through automation, creating comprehensive reports of pass/fail test cases.",
        ...
        },
        {
            ...
            time: "11 months ago",
            stars: 5,
            comment: "Exceptional experience working with GreenSolution and project manager Bushra Rizwan. Their innovative solutions and dedication exceeded all expectations.",
            bgColor: "bg-cyan-200",
        },
        {
            id: 12,
            ...
            <div className="px-6 md:px-16 py-6 md:py-10 max-w-7xl mx-auto">
                ...
                <div className="mx-auto poppins grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="rounded-lg overflow-hidden">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d108921.09762832048!2d74.28223660341418!3d31.44760464534993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3919055ce3897a39%3A0x3fd045ce5b387979!2sGreenSolution!5e0!3m2!1sen!2s!4v1738082908335!5m2!1sen!2s" width="526" height="602" loading="lazy"></iframe>
                    </div>
