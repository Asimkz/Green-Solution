...
const faqs = [
  ...
  {
    question: 'Why Choose GreenSolution Over Other Service Providers?',
    answer:
      'At GreenSolution, we offer a unique combination of experience, affordability, and expertise. We’re passionate about delivering results, with attention to detail and professionalism. If you want high-quality mobile app development at an affordable price, we’re the right fit.',
  },
  {
